...
| `crendentialSubject` | `object` | **REQUIRED.** 次の [credentialSubject のプロパティ](#credential-subject-properties)を含む JSON-LD Node Object です。 |
...
| `decription` | `string` | **OPTIONAL.** 認証制度の説明です。 |
