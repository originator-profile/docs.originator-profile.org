...
このセクションでは、[RFC7696 Section 2.2.3](https://www.rfc-editor.org/rfc/rfc7696.html#section-2.2.3)で要求されている、予想されるアルゴリズムの移行について通知することを目的として、また、鍵の更新と使用する暗号アルゴリズムの定期的な見直しに関する指針として、米国連邦政府が定める鍵管理の推奨事項についての文書である[NIST SP 800-57 Part 1](https://doi.org/10.6028/NIST.SP.800-57pt1r5)と、暗号技術の利用移行についての文書である[NIST SP 800-131A](https://doi.org/10.6028/NIST.SP.800-131Ar2)を参考に、次のとおり記します。
...
- ES384: 192-bit
- ES512: 256-bit
- PS256: ~128-bit（鍵長による。3072-bit以上のRSA鍵を推奨。2048-bitのRSA鍵の場合、112-bit）
- PS384: ~192-bit（鍵長による。3072-bit以上のRSA鍵を推奨。2048-bitのRSA鍵の場合、112-bit）
- PS512: ~256-bit（鍵長による。3072-bit以上のRSA鍵を推奨。2048-bitのRSA鍵の場合、112-bit）
