...
- ES384: 192 ビット
- ES512: 256 ビット
- PS256: ~128 ビット（鍵長による。3072 ビット以上のRSA鍵を推奨。2048 ビットのRSA鍵の場合、112 ビット）
- PS384: ~192 ビット（鍵長による。3072 ビット以上のRSA鍵を推奨。2048 ビットのRSA鍵の場合、112 ビット）
- PS512: ~256 ビット（鍵長による。3072 ビット以上のRSA鍵を推奨。2048 ビットのRSA鍵の場合、112 ビット）
