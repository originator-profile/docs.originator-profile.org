...
- [Certificate Data Model](./certificate.md): 証明書 PA のデータモデル。
  - [組織実在性証明書](./pa-model/existence.md)
  - [広告認証証明書](./pa-model/advertising-certification.md)
  - [報道機関登録証明書](./pa-model/news-media-registration.md)
  - [自治体認証証明書](./pa-model/municipality-certificate.md)
...
[Architectual Overview](pathname:///aov/) で定義されるモデルに属するデータモデルは、次のリンクから参照してください。
