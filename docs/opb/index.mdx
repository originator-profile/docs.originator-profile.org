...
- [Profile Annotation](./pa.md): PA には、送信者の組織が実在することの証明書、さまざまな認証機関によって付与された証明書に関する情報、さまざまな組織からの加盟証明書が含まれ、それぞれは適切な組織によって署名されています。
...
- Content Attestation
  ...
  - [記事広告](./ca-guide/advertorial.md): インターネット上の記事広告に紐づく CA のデータモデル。
- Profile Annotation
  - [Certificate Data Model](./certificate.md): 証明書 PA のデータモデル。
    - [組織実在性証明書](./pa-guide/existence.md)
    - [広告認証証明書](./pa-guide/advertising-certification.md)
    - [報道機関登録証明書](./pa-guide/news-media-registration.md)
    - [自治体認証証明書](./pa-guide/municipality-certificate.md)
