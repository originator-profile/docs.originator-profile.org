...
:::note[これらの文書はすべて<ruby>草案<rt>draft</rt></ruby>です。]
:::

:::note[「Originator Profile RFC (OP RFC)」と呼称していたOriginator Profile の技術仕様に関する文書について、IETF や W3C といった標準化団体の標準化プロセスとは異なるプロセスで運用していることを明確にするため、「Originator Profile Blueprint (OPB)」に名称変更しました。]
:::
...
- [自治体認証 PA](./pa-model/local-government-certification.md)
