...
| ------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@context`          | `string[]` | **REQUIRED.** [OP VC Data Model](./op-vc-data-model.md) に従ってください (MUST)。                                                                                                                                                                                                                                                                                                                               |
...
| `type`             | `string`   | **REQUIRED.** PA のタイプ名です。既存の型は [Profile Annotation Type Registry](./pa-model/index.mdx#registry) に登録されており、必要に応じて拡張して新しい型を定義できます。                                                                                                                 |
