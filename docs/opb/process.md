...
OPB の草案を提出した時点～遅くとも OPB の草案がレビューを経てマージ可能な時点で、以下のいずれかの対応を行う必要があります。
...
OPB がアクティブであるということは、OPB に基づいた実装が進行中または完了しており、コミュニティがそれを受け入れていることを意味します
