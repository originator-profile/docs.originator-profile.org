...
- JWTInvalid: JWT が無効な形式になっている可能性があります。
- JWTExpired: `exp` クレームが有効期限切れしている可能性があります。
- JWKSNoMatchingKey: `kid` ヘッダークレームに一致する鍵が見つからなかった可能性があります。
