...
- Support for the new Profile Annotation model has been added. The legacy `Certificate` model has been replaced by `ProfileAnnotation` (`certificationSystem` → `annotation`).
  ...
  ```
- Profile Annotation Issuer Registration: Added support for the PA model. → [Documentation](https://docs.originator-profile.org/en/opb/pa-model/profile-annotation-issuer-registration/)
...
- Pinpointed dependencies and updated the lockfile.
...
- fix: old ovac pa included digestSRI verification failure by @knokmki612 in https://github.com/originator-profile/originator-profile/pull/405
...
- feat: Add model for Profile Annotation Issuer Certificate (PA) by @kou029w in https://github.com/originator-profile/originator-profile/pull/424
...
- feat(verify): Add PA verification logic based on Profile Annotation Issuer Certificate (PA) by @kou029w in https://github.com/originator-profile/originator-profile/pull/434
