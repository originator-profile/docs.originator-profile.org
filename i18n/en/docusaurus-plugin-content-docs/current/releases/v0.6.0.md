---
original: https://github.com/originator-profile/docs.originator-profile.org/blob/109e643/docs/releases/v0.6.0.md
---
...
- 新しい Profile Annotation モデルに対応。従来の `Certificate` モデルは `ProfileAnnotation` に置き換わりました（`certificationSystem` → `annotation`）。
  ...
  ```
- Profile Annotation Issuer 登録証 PAのモデルに対応しました。→ [ドキュメント](https://docs.originator-profile.org/en/opb/pa-model/profile-annotation-issuer-registration/)
