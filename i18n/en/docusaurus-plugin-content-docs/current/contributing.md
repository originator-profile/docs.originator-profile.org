...
When contributing to the technical specifications or software developed under the Originator Profile project, please agree to the [DCO (Developer Certificate of Origin)](https://developercertificate.org/) and include a sign-off line (`Signed-off-by`) in your pull requests to the relevant GitHub repositories.
