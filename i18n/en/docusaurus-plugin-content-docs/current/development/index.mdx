...
1. Set up the environment for Linux, macOS or Windows ([WSL2](https://learn.microsoft.com/en-us/windows/wsl/install))
   - For Windows: Recommend to use WSL2 Ubuntu LTS
     - Please refer to [Update to the latest version including Linux GUI support](https://learn.microsoft.com/ja-jp/windows/wsl/tutorials/gui-apps#existing-wsl-install).
     - Run the command `sudo apt-get install -y fonts-noto-cjk` to install Japanese fonts.
2. Installing [Node.js](https://nodejs.org/en)
   - Please refer to [Downloading Node.js](https://nodejs.org/ja/download) or [Installing Node.js by using package manager](https://nodejs.org/ja/download/package-manager/all).
...
3. Installing [pnpm](https://pnpm.io/)
   - Please refer to [Installing pnpm](https://pnpm.io/ja/installation).
   - For Windows: To install in a WSL2 environment, see "[Using other package managers](https://pnpm.io/ja/installation#using-other-package-managers)".
