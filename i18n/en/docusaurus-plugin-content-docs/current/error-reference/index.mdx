---
original: https://github.com/originator-profile/docs.originator-profile.org/blob/fb58d87/docs/error-reference/index.mdx
---

# Error Reference

This page is documentation for error codes, such as verification failures, that may appear when verificationg a Site Profile, Originator Profile Set, or Content Attestation Set using the [extension](https://github.com/originator-profile/originator-profile/releases) or [debugger tool](https://playground.originator-profile.org/app/debugger).
The cause and solution for each error code are explained on the error code page.
