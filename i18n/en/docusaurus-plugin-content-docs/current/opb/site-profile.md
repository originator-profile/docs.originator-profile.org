---
sidebar_position: 33
original: https://github.com/originator-profile/docs.originator-profile.org/blob/d497a68/docs/opb/site-profile.md
---
...
| ------------- | ---------- | -------------------------------------- |
| `originators` | `object[]` | **REQUIRED.** This is an array of OPS. |
